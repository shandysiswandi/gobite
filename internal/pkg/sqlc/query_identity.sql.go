...
ORDER BY
  -- email
  CASE WHEN $5::text = 'email:asc'  THEN email END ASC,
  CASE WHEN $5::text = 'email:desc' THEN email END DESC,
  -- full_name
  CASE WHEN $5::text = 'full_name:asc'  THEN full_name END ASC,
  CASE WHEN $5::text = 'full_name:desc' THEN full_name END DESC,
  -- updated_at
  CASE WHEN $5::text = 'updated_at:asc'  THEN updated_at END ASC,
  CASE WHEN $5::text = 'updated_at:desc' THEN updated_at END DESC,
  -- status
  CASE WHEN $5::text = 'status:asc'  THEN status END ASC,
  CASE WHEN $5::text = 'status:desc' THEN status END DESC,
  -- fallback
