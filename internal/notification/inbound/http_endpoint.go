...
func (h *HTTPEndpoint) ListNotifications(r *router.Request) (any, error) {
	query := r.URL.Query()
	...
	items, err := h.uc.ListNotifications(r.Context(), usecase.ListNotificationsInput{
...
func (h *HTTPEndpoint) MarkNotificationRead(r *router.Request) (any, error) {
	id, err := strconv.ParseInt(r.GetParam("id"), 10, 64)
	if err != nil {
		return nil, goerror.NewInvalidFormat()
	}

	return nil, h.uc.MarkNotificationRead(r.Context(), usecase.MarkNotificationReadInput{ID: id})
}
...
func (h *HTTPEndpoint) MarkAllNotificationsRead(r *router.Request) (any, error) {
	return nil, h.uc.MarkAllNotificationsRead(r.Context())
}
...
func (h *HTTPEndpoint) DeleteNotification(r *router.Request) (any, error) {
	id, err := strconv.ParseInt(r.GetParam("id"), 10, 64)
	if err != nil {
		return nil, goerror.NewInvalidFormat()
	}

	return nil, h.uc.DeleteNotification(r.Context(), usecase.DeleteNotificationInput{ID: id})
}
