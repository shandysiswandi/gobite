...
import (
	...
	"github.com/shandysiswandi/gobite/internal/iam"
...
func (a *App) initModules() {
	...
	if a.config.GetBool("modules.iam.enabled") {
		if err := iam.New(iam.Dependency{
			Router:   a.router,
			Enforcer: a.casbin,
		}); err != nil {
			slog.Error("failed to init module IAM", "error", err)
			os.Exit(1)
		}
	}
