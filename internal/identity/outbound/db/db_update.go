...
func (s *DB) RevokeRefreshToken(ctx context.Context, token string) (err error) {
	...
	err = s.mapError(s.query.RevokeIdentityRefreshToken(ctx, token))
	return err
}
...
func (s *DB) RevokeAllRefreshToken(ctx context.Context, userID int64) (err error) {
	...
	err = s.mapError(s.query.RevokeAllIdentityRefreshToken(ctx, userID))
	return err
}
...
func (s *DB) UpdateMFALastUsedAt(ctx context.Context, factorID, userID int64) (err error) {
	...
	err = s.mapError(s.query.UpdateIdentityMFALastUsedAt(ctx, sqlc.UpdateIdentityMFALastUsedAtParams{
		ID:     factorID,
		UserID: userID,
	}))
	return err
...
func (s *DB) UpdateUserProfile(ctx context.Context, id int64, fullName string) (err error) {
	...
	err = s.mapError(s.query.UpdateIdentityUserName(ctx, sqlc.UpdateIdentityUserNameParams{
		ID:       id,
		FullName: fullName,
	}))
	return err
...
func (s *DB) UpdateUserAvatar(ctx context.Context, id int64, avatarURL string) (err error) {
	...
	err = s.mapError(s.query.UpdateIdentityUserAvatar(ctx, sqlc.UpdateIdentityUserAvatarParams{
		ID:        id,
		AvatarUrl: avatarURL,
	}))
	return err
...
func (s *DB) UpdateUserStatus(ctx context.Context, id int64, oldStatus, newStatus entity.UserStatus) (err error) {
	...
	err = s.mapError(s.query.UpdateIdentityUserStatus(ctx, sqlc.UpdateIdentityUserStatusParams{
		ID:        id,
		NewStatus: newStatus,
		OldStatus: oldStatus,
	}))
