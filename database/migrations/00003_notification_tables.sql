...
CREATE TABLE notification_user_settings (
    ...
    channel SMALLINT NOT NULL, -- (0: In-App, 1: Email, 2: SMS, 3: Push)
...
INSERT INTO notification_templates (id, trigger_key, category_id, channel, subject, body) VALUES
    (1, 'email_verify', 1, 1, 'Verify your email', 'Hi {{.full_name}},\n\nUse this token to verify your email:\n\n{{.token}}\n\nIf you did not request this, please ignore this email.'),
    (2, 'user_welcome', 2, 0, 'Welcome to Gobite', 'Welcome {{.full_name}}!');
